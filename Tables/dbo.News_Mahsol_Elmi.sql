CREATE TABLE [dbo].[News_Mahsol_Elmi]
(
...
[Groh] [nvarchar] (50) COLLATE Persian_100_CI_AS_SC_UTF8 NULL,
[Flag_Dasti] [bit] NULL,
...
[Darsad_Takhfif_Saderat] [nvarchar] (10) COLLATE Persian_100_CI_AS NULL CONSTRAINT [DF__News_Mahs__Darsa__14E61A24] DEFAULT ('0'),
[Takhfif_Saderat] [nvarchar] (10) COLLATE Persian_100_CI_AS NULL CONSTRAINT [DF__News_Mahs__Takhf__15DA3E5D] DEFAULT ('0'),
[Add_Saderat] [nvarchar] (10) COLLATE Persian_100_CI_AS NULL CONSTRAINT [DF__News_Mahs__Add_S__16CE6296] DEFAULT ('0'),
[Darsad_Add_Saderat] [nvarchar] (10) COLLATE Persian_100_CI_AS NULL CONSTRAINT [DF__News_Mahs__Darsa__17C286CF] DEFAULT ('0'),
[QC] [bit] NULL,
[QC_UserSubmit] [nvarchar] (30) COLLATE Persian_100_CI_AS NULL,
[QC_DateSubmit] [nvarchar] (50) COLLATE Persian_100_CI_AS NULL,
[StartTime] [datetime2] GENERATED ALWAYS AS ROW START NOT NULL CONSTRAINT [DF__News_Mahs__Start__18B6AB08] DEFAULT (sysutcdatetime()),
[EndTime] [datetime2] GENERATED ALWAYS AS ROW END NOT NULL CONSTRAINT [DF__News_Mahs__EndTi__19AACF41] DEFAULT (CONVERT([datetime2],'9999-12-31 23:59:59.9999999',(0))),
PERIOD FOR SYSTEM_TIME (StartTime, EndTime)
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[News_Mahsol_Elmi] ADD CONSTRAINT [PK__News_Mah__0666AFE81A2A494C] PRIMARY KEY NONCLUSTERED  ([Counter]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
