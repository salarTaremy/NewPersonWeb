CREATE TABLE [dbo].[News_mahsol_mashhad]
(
...
[StartTime] [datetime2] GENERATED ALWAYS AS ROW START NOT NULL CONSTRAINT [DF__News_mahs__Start__22401542] DEFAULT (sysutcdatetime()),
[EndTime] [datetime2] GENERATED ALWAYS AS ROW END NOT NULL CONSTRAINT [DF__News_mahs__EndTi__2334397B] DEFAULT (CONVERT([datetime2],'9999-12-31 23:59:59.9999999',(0))),
PERIOD FOR SYSTEM_TIME (StartTime, EndTime)
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[News_mahsol_mashhad] ADD CONSTRAINT [PK__News_mah__0666AFE911F0855F] PRIMARY KEY CLUSTERED  ([Counter]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
