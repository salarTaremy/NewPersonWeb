CREATE TABLE [dbo].[News_Mahsol_Esfahan]
(
...
[StartTime] [datetime2] GENERATED ALWAYS AS ROW START NOT NULL CONSTRAINT [DF__News_Mahs__Start__1A9EF37A] DEFAULT (sysutcdatetime()),
[EndTime] [datetime2] GENERATED ALWAYS AS ROW END NOT NULL CONSTRAINT [DF__News_Mahs__EndTi__1B9317B3] DEFAULT (CONVERT([datetime2],'9999-12-31 23:59:59.9999999',(0))),
PERIOD FOR SYSTEM_TIME (StartTime, EndTime)
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[News_Mahsol_Esfahan] ADD CONSTRAINT [PK__News_Mah__0666AFE880E1A5CB] PRIMARY KEY NONCLUSTERED  ([Counter]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
