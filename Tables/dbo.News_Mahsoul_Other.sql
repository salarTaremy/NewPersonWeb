CREATE TABLE [dbo].[News_Mahsoul_Other]
(
...
GO
ALTER TABLE [dbo].[News_Mahsoul_Other] ADD CONSTRAINT [PK__News_Mah__0666AFE913480C81] PRIMARY KEY CLUSTERED  ([Counter]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
