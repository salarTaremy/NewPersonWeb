CREATE TABLE [dbo].[News_Mahsol_Arak]
(
...
GO
ALTER TABLE [dbo].[News_Mahsol_Arak] ADD CONSTRAINT [PK__News_Mah__0666AFE821E92F3D] PRIMARY KEY NONCLUSTERED  ([Counter]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
