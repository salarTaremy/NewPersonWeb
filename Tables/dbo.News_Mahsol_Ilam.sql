CREATE TABLE [dbo].[News_Mahsol_Ilam]
(
[Code_kala] [varchar] (100) COLLATE Persian_100_CI_AS NULL,
...
[StartTime] [datetime2] GENERATED ALWAYS AS ROW START NOT NULL CONSTRAINT [DF__News_Mahs__Start__1C873BEC] DEFAULT (sysutcdatetime()),
[EndTime] [datetime2] GENERATED ALWAYS AS ROW END NOT NULL CONSTRAINT [DF__News_Mahs__EndTi__1D7B6025] DEFAULT (CONVERT([datetime2],'9999-12-31 23:59:59.9999999',(0))),
PERIOD FOR SYSTEM_TIME (StartTime, EndTime)
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[News_Mahsol_Ilam] ADD CONSTRAINT [PK__News_Mah__0666AFE8A01C0F79] PRIMARY KEY NONCLUSTERED  ([Counter]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
