CREATE TABLE [dbo].[News_Mahsol_Tabriz]
(
...
[StartTime] [datetime2] GENERATED ALWAYS AS ROW START NOT NULL CONSTRAINT [DF__News_Mahs__Start__27F8EE98] DEFAULT (sysutcdatetime()),
[EndTime] [datetime2] GENERATED ALWAYS AS ROW END NOT NULL CONSTRAINT [DF__News_Mahs__EndTi__28ED12D1] DEFAULT (CONVERT([datetime2],'9999-12-31 23:59:59.9999999',(0))),
PERIOD FOR SYSTEM_TIME (StartTime, EndTime)
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[News_Mahsol_Tabriz] ADD CONSTRAINT [PK__News_Mah__0666AFE9B9C7D253] PRIMARY KEY CLUSTERED  ([Counter]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
