CREATE TABLE [dbo].[News_Mahsol_Internet]
(
...
[StartTime] [datetime2] NOT NULL CONSTRAINT [DF__News_Mahs__Start__1E6F845E] DEFAULT (sysutcdatetime()),
[EndTime] [datetime2] NOT NULL CONSTRAINT [DF__News_Mahs__EndTi__1F63A897] DEFAULT (CONVERT([datetime2],'9999-12-31 23:59:59.9999999',(0)))
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[News_Mahsol_Internet] ADD CONSTRAINT [PK__News_Mah__0666AFE94D51FAC6] PRIMARY KEY CLUSTERED  ([Counter]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
